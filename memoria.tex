...
\begin{titlepage}
    ...
    \vspace{0.3cm}\rule{\linewidth}{0.5pt}
    \vspace{0.6cm}

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textwidth]{imagenes/fotos-circuito/circuitocompleto1.jpeg}
        \caption*{Montaje final del sistema}
    \end{figure}


    \begin{tabular}{rl}
        \textbf{Autores:}    & Pablo Galilea Valverde \\[2pt]
                             & Pedro Zhuhan \\[4pt]
